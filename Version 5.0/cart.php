                ...
                <?php else: ?>
                    <div class="d-flex flex-row flex-wrap"> 
                            <?php foreach($cart as $product => $amount): ?>
                                <?php if($amount > 0): ?>
                                    <div class="card ms-3 mt-4 flex-shrink-1" style="width: 15rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center">Amount: <?= $amount ?></p>
                                            <form action="cart.php" method="POST">
                                                <input type="hidden" name='product_id' value='<?= $product ?>'>
                                                <div class="w-50 d-flex justify-content-between ms-5">
                                                    <input class="border rounded-start bg-danger text-white" type="submit" name="action" value="-">
                                                    <label for="amount"><?= $amount ?></label>
                                                    <input class="border rounded-end bg-success text-white" type="submit" name="action" value="+">
                                                </div>
                                            </form> 
                                        </div>
                                    </div>
